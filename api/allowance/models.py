...
class allowance(models.Model):
    ...
    a_mailremind = models.BooleanField(verbose_name='Автонапоминание на почту', default=0)
    a_mail_sended = models.BooleanField(verbose_name='Отправлено на почту', default=0)
